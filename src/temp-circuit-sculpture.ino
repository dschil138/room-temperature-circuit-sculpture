...
#define SCREEN_ADDRESS 0x3C // This is the standard I2C address for SSD1306 Oleds, check your data sheet if it doesn't work
...
void loop() {
  ...
  // "true" for Fahrenheit, leave empty for Celcius
